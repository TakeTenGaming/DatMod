...
public class Materials
{
	...
	public static ItemArmor.ArmorMaterial diamondiumArmor = EnumHelper.addArmorMaterial ( "diamondium", getTextureName ( "diamondium" ), 2000, new int[] { 2, 7, 5, 3 }, 14,
			equipDiamond, 2.0F );

	public static Item.ToolMaterial emeraldi = EnumHelper.addToolMaterial ( "emeraldi", 3, 800, 11.0F, 3.5F, 20 );
	public static ItemArmor.ArmorMaterial emeraldiArmor = EnumHelper.addArmorMaterial ( "emeraldi", getTextureName ( "emeraldi" ), 800, new int[] { 2, 7, 5, 3 }, 20, equipIron,
			1.0F );

	public static Item.ToolMaterial goldirite = EnumHelper.addToolMaterial ( "goldirite", 3, 125, 15.0F, 1.0F, 24 );
	public static ItemArmor.ArmorMaterial goldiriteArmor = EnumHelper.addArmorMaterial ( "goldirite", getTextureName ( "goldirite" ), 125, new int[] { 2, 7, 5, 3 }, 24, equipGold,
			0.0F );
	...
	public static ItemArmor.ArmorMaterial lapisLazuliArmor = EnumHelper.addArmorMaterial ( "lapisLazuli", getTextureName ( "lapislazuli" ), 500, new int[] { 2, 7, 5, 3 }, 18,
			equipDiamond, 1.0F );

	public static Item.ToolMaterial redstone = EnumHelper.addToolMaterial ( "redstone", 3, 500, 8.5F, 4.0F, 18 );
	public static ItemArmor.ArmorMaterial redstoneArmor = EnumHelper.addArmorMaterial ( "redstone", getTextureName ( "redstone" ), 500, new int[] { 2, 7, 5, 3 }, 18,
			equipDiamond, 1.0F );

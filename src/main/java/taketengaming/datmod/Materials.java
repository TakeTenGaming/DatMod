...
public class Materials
{
	...
	// Armor Materials
	public static ItemArmor.ArmorMaterial diamondiumArmor = EnumHelper.addArmorMaterial ( "diamondium", getTextureName ( "diamondium" ), 2000, new int[] { 4, 7, 7, 3 }, 14, equipDiamond, 2.5F );
	public static ItemArmor.ArmorMaterial emeraldiArmor = EnumHelper.addArmorMaterial ( "emeraldi", getTextureName ( "emeraldi" ), 800, new int[] { 2, 7, 5, 3 }, 20, equipIron, 1.0F );
	public static ItemArmor.ArmorMaterial goldiriteArmor = EnumHelper.addArmorMaterial ( "goldirite", getTextureName ( "goldirite" ), 125, new int[] { 2, 7, 5, 3 }, 24, equipGold, 0.0F );
	public static ItemArmor.ArmorMaterial ironiumArmor = EnumHelper.addArmorMaterial ( "ironium", getTextureName ( "ironium" ), 500, new int[] { 2, 7, 5, 3 }, 18, equipIron, 0.0F );
	public static ItemArmor.ArmorMaterial lapisLazuliArmor = EnumHelper.addArmorMaterial ( "lapisLazuli", getTextureName ( "lapislazuli" ), 500, new int[] { 2, 3, 5, 3 }, 18, equipDiamond, 1.0F );
	public static ItemArmor.ArmorMaterial redstoneArmor = EnumHelper.addArmorMaterial ( "redstone", getTextureName ( "redstone" ), 500, new int[] { 2, 7, 5, 3 }, 18, equipDiamond, 1.0F );

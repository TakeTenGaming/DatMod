...
public class PlayedLoggedIn
{
	...
	public void playedLoggedIn ( PlayerEvent.PlayerLoggedInEvent event )
	{
		...
		if ( ConfigHandler.enableWelcomeMessage )
		{
			...
			player.addChatComponentMessage ( ForgeHooks.newChatWithLinks ( "Thanks for trying our mod, " + TextFormatting.WHITE + player.getDisplayNameString () + TextFormatting.GRAY

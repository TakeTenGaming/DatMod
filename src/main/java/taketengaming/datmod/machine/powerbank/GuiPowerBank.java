...
{
	private static final ResourceLocation background = new ResourceLocation ( DatMod.MODID, "textures/gui/powerbank.png" );
	...
	protected void drawGuiContainerForegroundLayer ( int mouseX, int mouseY )
	{
		...
		FontRenderer fontObj = this.fontRendererObj;

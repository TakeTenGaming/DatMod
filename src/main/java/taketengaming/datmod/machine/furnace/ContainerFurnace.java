...
{
	private final TileEntityFurnace tileEntityFurnace;
	...
	{
		IItemHandler itemHandler = this.tileEntityFurnace.getCapability ( CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null );
		int x = 0;
		int y = 0;
	...
	{
		return this.tileEntityFurnace.canInteractWith ( playerIn );
	}

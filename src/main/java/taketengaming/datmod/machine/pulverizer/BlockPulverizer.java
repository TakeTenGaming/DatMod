 ...
 */
public class BlockPulverizer extends BlockFacable implements ITileEntityProvider
{
	private static final int GUI_ID = GuiHandler.ENERGIZED_PULVERIZER;

	public BlockPulverizer ()
	{
		super ( Material.ROCK, "Pulverizer" );
	...
	public boolean onBlockActivated ( World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ )
	{
		...
		if ( !( te instanceof TileEntityPulverizer ) )
		{
			return false;
		}

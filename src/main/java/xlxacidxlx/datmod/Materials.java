...
public class Materials {
	 ...
	 * Harvest Level - What harvest level the material has
	 * Durability - The amount of durability the item has
	 * Efficiency - How quick the tool can mine things
	 * Damage - The amount of damage the tool does vs entities
	 * Enchantability - How well the tool takes enchantments
	 */
	 ...
	 *
	 * Name - The name of the material
	 * Texture Name - Where th find the material's texture?
	 * Durability - The amount of durability the item has
	 * Reduction Amount - The amount of damage taken by the armor, 1 value=1/2 a heart (1 - helmet, 2 - chest, 3 - leggings, 4 - boots)
	 * Enchantability - How well the armor takes enchantments
	 * Sound on Equip - The sound played when an armor piece is equipped
	 * Toughness - ??
	 */
